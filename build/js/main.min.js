...
!(function (e, t) {
	...
	var T = (function (e) {
		...
		(oe.attr = function (e, t) {
			...
			var a = i.attrHandle[t.toLowerCase()],
				r = a && P.call(i.attrHandle, t.toLowerCase()) ? a(e, t, !m) : void 0;
			return void 0 !== r
				? r
				: n.attributes || !m
				? e.getAttribute(t)
		...
		function Se(e, t, n, i, a) {
			for (var r, s = [], o = 0, l = e.length, c = null != t; o < l; o++)
				(r = e[o]) && ((n && !n(r, i, a)) || (s.push(r), c && t.push(o)));
			return s;
		}
			...
			return (
				...
				ce(function (r, s, o, l) {
					var c,
						...
						v = !e || (!r && t) ? m : Se(m, p, e, o, l),
						g = n ? (a || (r ? e : h || i) ? [] : s) : v;
					if ((n && n(v, g, o, l), i))
						for (c = Se(g, f), i(c, [], o, l), d = c.length; d--; )
							(u = c[d]) && (g[f[d]] = !(v[f[d]] = u));
					if (r) {
						if (a || e) {
							if (a) {
					...
					} else (g = Se(g === s ? g.splice(h, g.length) : g)), a ? a(null, s, g, l) : D.apply(s, g);
				})
			);
		}
		function Ee(e) {
			...
			(s = oe.tokenize =
				function (e, t) {
					...
					for (o = e, l = [], c = i.preFilter; o; ) {
						for (s in ((n && !(a = B.exec(o))) ||
							(a && (o = o.slice(a[0].length) || o), l.push((r = []))),
						(n = !1),
						(a = W.exec(o)) &&
							((n = a.shift()),
							r.push({ value: n, type: a[0].replace(F, " ") }),
							(o = o.slice(n.length))),
						i.filter))
							!(a = G[s].exec(o)) ||
								(c[s] && !(a = c[s](a))) ||
						...
						(v = $(
							...
							(d = function (e, t, n, s, d) {
								...
								if (((g += y), o && y !== g)) {
									...
									if (e) {
										if (0 < g) for (; y--; ) b[y] || w[y] || (w[y] = z.call(s));
										w = Se(w);
									}
									D.apply(s, w),
										d &&
			...
			function (e, t) {
				x.fn[e] = function (n, i) {
					...
					return (
						...
						1 < this.length &&
							(D[e] || x.uniqueSort(a), A.test(e) && a.reverse()),
						this.pushStack(a)
					);
				};
			}
	...
	(x.Callbacks = function (e) {
		...
		x.extend({
				...
				var n = [
					...
					a = {
						...
						then: function (t, i, a) {
							...
							return x
								.Deferred(function (e) {
									n[0][3].add(s(0, e, h(a) ? a : q, e.notifyWith)),
										n[1][3].add(s(0, e, h(t) ? t : q)),
										n[2][3].add(s(0, e, h(i) ? i : _));
								})
								.promise();
						},
						promise: function (e) {
			...
			when: function (e) {
				...
				if (
					t <= 1 &&
					(N(e, s.done(o(n)).resolve, s.reject, !t),
	...
	var le = {};
	function ce(e, t) {
		for (var n, i, a, r, s, o, l, c = [], d = 0, u = e.length; d < u; d++)
			(i = e[d]).style &&
				((n = i.style.display),
				t
					? ("none" === n &&
							((c[d] = U.get(i, "display") || null),
							c[d] || (i.style.display = "")),
					  "" === i.style.display &&
							se(i) &&
							(c[d] =
	...
	function be(e, t, n, i, a) {
		...
		for (u.textContent = "", f = 0; (r = p[f++]); )
			if (i && -1 < x.inArray(r, i)) a && a.push(r);
				...
				((c = ae(r)), (s = ve(u.appendChild(r), "script")), c && ge(s), n)
			)
		...
		special: {
			...
			click: {
				setup: function (e) {
					var t = this || e;
					return (
						pe.test(t.type) && t.click && M(t, "input") && Ce(t, "click", xe),
						!1
					);
				},
				trigger: function (e) {
					var t = this || e;
					return (
						pe.test(t.type) && t.click && M(t, "input") && Ce(t, "click"), !0
					);
				},
				_default: function (e) {
					var t = e.target;
	...
	function De(e, t, n, i) {
		...
		if (g || (1 < p && "string" == typeof v && !f.checkClone && Me.test(v)))
			return e.each(function (a) {
				var r = e.eq(a);
				g && (t[0] = v.call(this, a, r.html())), De(r, t, n, i);
			});
		if (
			p &&
			...
			for (l = (o = x.map(ve(a, "script"), Le)).length; u < p; u++)
				(c = a),
					u !== m &&
						((c = x.clone(c, !0, !0)), l && x.merge(o, ve(c, "script"))),
					n.call(e[u], c, u);
			if (l)
				for (d = o[o.length - 1].ownerDocument, x.map(o, ze), u = 0; u < l; u++)
					(c = o[u]),
						he.test(c.type || "") &&
							...
							(c.src && "module" !== (c.type || "").toLowerCase()
								...
								: y(c.textContent.replace(ke, ""), c, d));
		}
		return e;
	}
	function Ie(e, t, n) {
	...
	x.extend({
		...
		clone: function (e, t, n) {
			...
			if (
				...
				for (s = ve(d), i = 0, a = (r = ve(e)).length; i < a; i++)
					(o = r[i]),
			...
			if (t)
				if (n)
					for (r = r || ve(e), s = s || ve(d), i = 0, a = r.length; i < a; i++)
						Ae(r[i], s[i]);
				else Ae(e, d);
			return (
	...
	x.extend({
		...
		style: function (e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				if (
					...
					return s && "get" in s && void 0 !== (a = s.get(e, !1, i)) ? a : c[t];
				"string" == (r = typeof n) &&
					(a = te.exec(n)) &&
					a[1] &&
					((n = oe(e, t, a)), (r = "number")),
		...
		x.each(["height", "width"], function (e, t) {
			x.cssHooks[t] = {
				get: function (e, n, i) {
					if (n)
						return !Xe.test(x.css(e, "display")) ||
				...
				if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(f))
					...
					f))
						l ||
							...
							m && ce([e], !0),
							p.done(function () {
								for (i in (m || ce([e]), U.remove(e, "fxshow"), f))
									x.style(e, i, f[i]);
							})),
							(l = lt(m ? v[i] : 0, i, p)),
							i in v ||
						...
						u
							? (f.ifModified &&
									((S = E.getResponseHeader("Last-Modified")) &&
										(x.lastModified[a] = S),
									(S = E.getResponseHeader("etag")) && (x.etag[a] = S)),
							  204 === t || "HEAD" === f.type
									? (T = "nocontent")
									: 304 === t
									? (T = "notmodified")
									: ((T = w.state), (p = w.data), (u = !(v = w.error))))
							: ((v = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
						(E.status = t),
						(E.statusText = (n || T) + ""),
						u ? g.resolveWith(h, [p, T, E]) : g.rejectWith(h, [E, T, v]),
						E.statusCode(b),
						(b = void 0),
						d && m.trigger(u ? "ajaxSuccess" : "ajaxError", [E, f, u ? p : v]),
						y.fireWith(h, [E, T]),
						d &&
	...
	x.ajaxSetup({
		...
		x.each(["top", "left"], function (e, t) {
			x.cssHooks[t] = je(f.pixelPosition, function (e, n) {
				if (n)
					return (n = He(e, t)), Oe.test(n) ? x(e).position()[t] + "px" : n;
			});
		}),
					...
					for (var o = i.split(" "), l = 0; l < o.length; l += 1)
						for (var c = o[l], d = 0; d < this.length; d += 1) {
							...
							if (
								(!a && u.dom7Listeners
									? (p = u.dom7Listeners[c])
									: a && u.dom7LiveListeners && (p = u.dom7LiveListeners[c]),
								p && p.length)
							)
		...
		function C() {
			for (
				var e = Object(arguments.length <= 0 ? void 0 : arguments[0]),
					...
					n = "undefined" != typeof window ? window.HTMLElement : void 0,
					i = 1;
				i < arguments.length;
				i += 1
			) {
				var a = i < 0 || arguments.length <= i ? void 0 : arguments[i];
				if (null != a && !(n && a instanceof n))
					for (
						...
						void 0 !== c &&
							...
							(E(e[l]) && E(a[l])
								? a[l].__swiper__
									...
									: C(e[l], a[l])
								: !E(e[l]) && E(a[l])
								? ((e[l] = {}), a[l].__swiper__ ? (e[l] = a[l]) : C(e[l], a[l]))
								: (e[l] = a[l]));
					}
			}
			return e;
					...
					if (!i.isTouchEvent || "touchmove" === l.type) {
						...
						if (!n.allowTouchMove)
							return (
								...
								void (
									i.isTouched &&
									(C(s, { startX: d, startY: u, currentX: d, currentY: u }),
									(i.touchStartTime = S()))
								)
							);
			...
			if (t.enabled) {
				...
				if (
					...
					if (i.freeMode) {
							...
							if (n.velocities.length > 1) {
								...
								(t.velocity = m / v),
									...
									Math.abs(t.velocity) < i.freeModeMinimumVelocity &&
										(t.velocity = 0),
									(v > 150 || S() - f.time > 300) && (t.velocity = 0);
							} else t.velocity = 0;
						...
						for (
							var L = 0, z = t.slidesSizesGrid[0], A = 0;
							A < o.length;
							A += A < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup
						) {
							var D = A < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
							void 0 !== o[A + D]
								? d >= o[A] && d < o[A + D] && ((L = A), (z = o[A + D] - o[A]))
								: d >= o[A] &&
								  ((L = A), (z = o[o.length - 1] - o[o.length - 2]));
						}
						var I = (d - o[L]) / z,
						...
						if (p > i.longSwipesMs) {
							...
							"next" === t.swipeDirection &&
								(I >= i.longSwipesRatio ? t.slideTo(L + O) : t.slideTo(L)),
								"prev" === t.swipeDirection &&
									(I > 1 - i.longSwipesRatio ? t.slideTo(L + O) : t.slideTo(L));
						} else {
							if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
							!t.navigation ||
							(c.target !== t.navigation.nextEl &&
								c.target !== t.navigation.prevEl)
								? ("next" === t.swipeDirection && t.slideTo(L + O),
				...
				update: {
						...
						if (void 0 !== r) {
							...
							for (
								var $,
									...
									P = i.slidesPerColumn,
									L = T / P,
									z = Math.floor(u / i.slidesPerColumn),
									A = 0;
								A < u;
								A += 1
							) {
								...
								if (i.slidesPerColumn > 1) {
									...
									if ("row" === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
										var _ = Math.floor(
											...
											N = A - i.slidesPerColumn * i.slidesPerGroup * _,
											H =
												0 === _
													? i.slidesPerGroup
													: Math.min(
															Math.ceil((u - _ * P * i.slidesPerGroup) / P),
															i.slidesPerGroup
													  );
										(I =
											(O =
										...
										"column" === i.slidesPerColumnFill
											? ((q = A - (O = Math.floor(A / P)) * P),
											  (O > z || (O === z && q === P - 1)) &&
													(q += 1) >= P &&
													((q = 0), (O += 1)))
											: (O = A - (q = Math.floor(A / L)) * L);
									D.css(
										t("margin-top"),
										0 !== q ? i.spaceBetween && i.spaceBetween + "px" : ""
									);
								}
								if ("none" !== D.css("display")) {
									if ("auto" === i.slidesPerView) {
										var j = getComputedStyle(D[0]),
										...
										if (
											...
											if (G && "border-box" === G) E = B + V + Y;
											else {
												var U = D[0],
													Q = U.clientWidth;
												E = B + W + X + V + Y + (U.offsetWidth - Q);
											}
										}
							...
							if (
								...
								i.slidesPerColumn > 1 &&
									((e.virtualSize = (E + i.spaceBetween) * T),
									(e.virtualSize =
					...
					updateProgress: function (e) {
						...
						0 === a
							...
							C(t, { progress: r, isBeginning: s, isEnd: o }),
					...
					slideTo: function (e, t, n, i, a) {
						...
						if (l.cssMode) {
							var E,
								...
								$ = -b;
							return (
								f && ($ = h.scrollWidth - h.offsetWidth - $),
								0 === t
									? (h[C ? "scrollLeft" : "scrollTop"] = $)
									: h.scrollTo
									? h.scrollTo(
											(((E = {})[C ? "left" : "top"] = $),
											(E.behavior = "smooth"),
				...
				loop: {
					loopCreate: function () {
						...
						for (var u = 0; u < d.length; u += 1)
							i.append(v(d[u].cloneNode(!0)).addClass(n.slideDuplicateClass));
						for (var p = c.length - 1; p >= 0; p -= 1)
							i.prepend(v(c[p].cloneNode(!0)).addClass(n.slideDuplicateClass));
					},
					loopFix: function () {
						var e = this;
						...
						if (!l.touch && l.pointerEvents)
							...
							if (l.touch) {
								...
								a.addEventListener(i.start, e.onTouchStart, d),
									...
									R || (t.addEventListener("touchstart", F), (R = !0));
							}
						...
						if (
							...
							for (var l = 0; l < s.length; l += 1) {
								var c = s[l],
									...
									u = c.value;
								"window" === t
									? a.matchMedia("(min-width: " + u + "px)").matches && (i = d)
									: u <= n.clientWidth && (i = d);
							}
							return i || "max";
						}
			...
			V = (function () {
				...
				return (
					...
					(a.slidesPerViewDynamic = function () {
						...
						if (t.centeredSlides) {
							for (
								var o, l = n[r].swiperSlideSize, c = r + 1;
								c < n.length;
								c += 1
							)
								n[c] &&
							...
							for (var d = r - 1; d >= 0; d -= 1)
								n[d] &&
									!o &&
									((s += 1), (l += n[d].swiperSlideSize) > a && (o = !0));
						} else
							for (var u = r + 1; u < n.length; u += 1)
								i[u] - i[r] < a && (s += 1);
						return s;
					}),
					(a.update = function () {
		...
		var Y = {
				update: function (e) {
					...
					if (
						...
						return (
							t.slidesGrid !== f && S !== m && t.slides.css(v, S + "px"),
			...
			U = {
				handle: function (e) {
					...
					if (t.enabled) {
						...
						if (
							!t.allowSlideNext &&
							((t.isHorizontal() && f) || (t.isVertical() && m) || u)
						)
							return !1;
						if (
							!t.allowSlidePrev &&
							...
							t.isHorizontal()
								? ((d || u || p || f) &&
										(s.preventDefault
											? s.preventDefault()
											: (s.returnValue = !1)),
								  (((u || f) && !a) || ((d || p) && a)) && t.slideNext(),
								  (((d || p) && !a) || ((u || f) && a)) && t.slidePrev())
								: ((d || u || h || m) &&
										(s.preventDefault
											? s.preventDefault()
											: (s.returnValue = !1)),
			...
			J = {
				update: function () {
					...
					if (
						...
						if (
							...
							if (
								(n.dynamicBullets &&
									...
									(c =
										((l = o + (Math.min(d.length, n.dynamicMainBullets) - 1)) +
											o) /
										2)),
								d.removeClass(
									n.bulletActiveClass +
						...
						if (
							("fraction" === n.type &&
								(r.find(M(n.currentClass)).text(n.formatFractionCurrent(i + 1)),
								r.find(M(n.totalClass)).text(n.formatFractionTotal(s))),
							"progressbar" === n.type)
						) {
							var x;
							...
							var S = (i + 1) / s,
								T = 1,
								E = 1;
							"horizontal" === x ? (T = S) : (E = S),
								r
									.find(M(n.progressbarFillClass))
									.transform(
							...
							for (var s = 0; s < r; s += 1)
								t.renderBullet
									...
									: (a +=
											...
											t.bulletElement +
											">");
							i.html(a), (e.pagination.bullets = i.find(M(t.bulletClass)));
						}
						"fraction" === t.type &&
							((a = t.renderFraction
				...
				init: function () {
					...
					if (t.el) {
						...
						0 !== n.length &&
							...
							t.clickable &&
								n.on("click", M(t.bulletClass), function (t) {
									t.preventDefault();
				...
				destroy: function () {
					...
					if (
						...
						n.removeClass(t.hiddenClass),
							...
							t.clickable && n.off("click", M(t.bulletClass));
					}
				},
			},
			ee = {
				...
				updateSize: function () {
					...
					if (e.params.scrollbar.el && e.scrollbar.el) {
						...
						(a =
							...
							C(t, { trackSize: r, divider: s, moveDivider: o, dragSize: a }),
							e.params.watchOverflow &&
								e.enabled &&
				...
				init: function () {
					...
					if (i.el) {
						...
						0 === r.length &&
							...
							a.append(r)),
							C(t, { $el: a, el: a[0], $dragEl: r, dragEl: r[0] }),
			...
			ne = {
				...
				onGestureStart: function (e) {
					...
					if (
						...
						(a.fakeGestureTouched = !0),
							(r.scaleStart = ne.getDistanceBetweenTouches(e));
					}
				...
				in: function (e) {
					...
					T.$slideEl ||
						(e &&
							e.target &&
							(T.$slideEl = v(e.target).closest("." + b.params.slideClass)),
						T.$slideEl ||
							...
							0 !== r.length &&
								r.each(function (e) {
									...
									var s = r.attr("data-background"),
										...
										c = r.attr("data-sizes"),
										d = r.parent("picture");
									n.loadImage(r[0], o || s, l, c, !1, function () {
											...
											if (
												(s
													...
													: (l &&
													  ...
													  c &&
															(r.attr("sizes", c), r.removeAttr("data-sizes")),
													  d.length &&
						...
						if (o > 1 || (s.loadPrevNextAmount && s.loadPrevNextAmount > 1)) {
							for (
								var u = s.loadPrevNextAmount,
									p = o,
									f = Math.min(a + p + Math.max(u, p), i.length),
									h = Math.max(a - Math.max(p, u), 0),
									m = a + o;
								m < f;
								m += 1
							)
				...
				onEnterOrSpaceKey: function (e) {
					if (13 === e.keyCode || 32 === e.keyCode) {
						...
						t.navigation &&
							...
							t.pagination &&
								i.is(M(t.params.pagination.bulletClass)) &&
								i[0].click();
					}
				},
				notify: function (e) {
				...
				destroy: function () {
					...
					n.a11y.liveRegion &&
						...
						n.pagination &&
							...
							n.pagination.$el.off(
								"keydown",
								M(n.params.pagination.bulletClass),
				...
				init: function () {
					...
					if (
						...
						e.params.hashNavigation.watchState &&
							v(n).on("hashchange", e.hashNavigation.onHashCange);
					}
				},
				destroy: function () {
					var e = o();
					...
					for (var h = 0; h < a.length; h += 1) {
						...
						if (
							...
							0 === C.length &&
								...
								$.length && ($[0].style.opacity = Math.max(w, 0));
						}
					}
					if (
						(i.css({
					...
					for (
						...
						if (
							...
							0 === C.length &&
								...
								$.length && ($[0].style.opacity = -m > 0 ? -m : 0);
						}
					}
				},
				setTransition: function (e) {
			...
			he = [
				...
				},
				{
					...
					create: function () {
						$(this, { pagination: t({ dynamicBulletIndex: 0 }, J) });
					},
					on: {
						init: function (e) {
				...
				},
				{
					...
					create: function () {
						$(this, { lazy: t({ initialImageLoaded: !1 }, ie) });
					},
					on: {
						beforeInit: function (e) {
				...
				},
				{
					...
					create: function () {
						$(this, { hashNavigation: t({ initialized: !1 }, oe) });
					},
					on: {
						init: function (e) {
				...
				},
				{
					...
					create: function () {
						$(this, { autoplay: t({}, le, { running: !1, paused: !1 }) });
					},
					on: {
						init: function (e) {
				...
				},
				{
					...
					create: function () {
						$(this, { thumbs: t({ swiper: null, initialized: !1 }, fe) });
					},
					on: {
						beforeInit: function (e) {
		...
		return (function n(i) {
			...
			function r(t, n, r) {
				if ("undefined" != typeof document) {
					"number" == typeof (r = e({ path: "/" }, a.defaults, r)).expires &&
		...
		function a(e, t) {
			...
			(e && e.isDefaultPrevented()) ||
				...
				((r = n.fancybox.getInstance()) && r.$trigger && r.$trigger.is(i)) ||
					(t.selector
						? (s = n(t.selector))
						: (a = i.attr("data-fancybox") || "")
						? (s = (s = e.data ? e.data.items : []).length
								? s.filter('[data-fancybox="' + a + '"]')
								: n('[data-fancybox="' + a + '"]'))
						: (s = [i]),
					(o = n(s).index(i)) < 0 && (o = 0),
					((r = n.fancybox.open(s, t, o)).$trigger = i)));
		}
			...
			var r = {
				...
				h = function (e) {
					...
					return (
						...
						(a = t.elementFromPoint(i.x, i.y) === e),
				...
				m = function (e, t, i) {
					...
					(a.opts = f({ index: i }, n.fancybox.defaults)),
						n.isPlainObject(t) && (a.opts = f(a.opts, t)),
			...
			n.extend(m.prototype, {
				...
				addContent: function (e) {
					...
					n.each(a, function (e, t) {
						...
						n.isPlainObject(t)
							...
							? ((d = (a = n(t)).data() || {}),
							  ((d = n.extend(!0, {}, d, d.options)).$orig = a),
							  (c.src = i.opts.src || d.src || a.attr("href")),
						...
						o.on("keydown.fb", function (e) {
							...
							if (9 != a)
								return !i.opts.keyboard ||
									...
									: void t.trigger("afterKeydown", e, a);
				...
				createSlide: function (e) {
					var t,
						...
						a = this;
					return (
						(i = (i = e % a.group.length) < 0 ? a.group.length + i : i),
						!a.slides[e] &&
							a.group[i] &&
							((t = n('<div class="fancybox-slide"></div>').appendTo(
								a.$refs.stage
							)),
							(a.slides[e] = n.extend(!0, {}, a.group[i], {
								pos: e,
								$slide: t,
								isLoaded: !1,
							})),
				...
				scaleToActual: function (e, t, i) {
					...
					c.isAnimating ||
						...
						(e = void 0 === e ? 0.5 * p : e),
						(t = void 0 === t ? 0.5 * f : t),
						((a = n.fancybox.getTranslate(u)).top -= n.fancybox.getTranslate(
							d.$slide
						).top),
						(a.left -= n.fancybox.getTranslate(d.$slide).left),
						(o = h / a.width),
						(l = m / a.height),
						(r = 0.5 * p - 0.5 * h),
						(s = 0.5 * f - 0.5 * m),
						h > p &&
							((r = a.left * o - (e * o - e)) > 0 && (r = 0),
							r < p - h && (r = p - h)),
						m > f &&
							((s = a.top * l - (t * l - t)) > 0 && (s = 0),
							s < f - m && (s = f - m)),
						c.updateCursor(h, m),
						n.fancybox.animate(
							u,
							{ top: s, left: r, scaleX: o, scaleY: l },
							i || 366,
							function () {
								c.isAnimating = !1;
							}
				...
				getFitPos: function (e) {
					...
					return (
						...
						(l && c) || ((l = t), (c = i)),
						(l *= a = Math.min(1, t / l, i / c)) > t - 0.5 && (l = t),
						(c *= a) > i - 0.5 && (c = i),
						"image" === e.type
							? ((d.top =
									Math.floor(0.5 * (i - c)) + parseFloat(o.css("paddingTop"))),
							  (d.left =
									Math.floor(0.5 * (t - l)) + parseFloat(o.css("paddingLeft"))))
							: "video" === e.contentType &&
							  (c >
							  l /
									(r =
				...
				updateSlide: function (e, t) {
					...
					i.adjustCaption(e),
						a &&
							...
							!e.hasError &&
							(n.fancybox.stop(a),
							n.fancybox.setTranslate(a, i.getFitPos(e)),
				...
				isMoved: function (e) {
					...
					return (
						...
						(t = n.fancybox.getTranslate(a.$slide)),
				...
				isScaledDown: function (e, t) {
					...
					return (
						void 0 !== e && void 0 !== t
							? (i = e < a.width && t < a.height)
							: r &&
							  (i =
									(i = n.fancybox.getTranslate(r)).width < a.width &&
									i.height < a.height),
						i
					);
				},
				...
				resolveImageSlideSize: function (e, t, n) {
					...
					(e.width = t),
						...
						a > 0 && ((e.width = Math.floor((a * t) / n)), (e.height = a));
				},
						...
						r &&
							...
							(i.pos !== n.currPos
								? ((t = s.clone().appendTo(s.parent()))
								  ...
								  (o = t.outerHeight(!0)),
								  t.empty().remove())
								: n.$caption && (o = n.$caption.outerHeight(!0)),
				...
				revealContent: function (e) {
					...
					return (
						...
						(a = parseInt(
							void 0 === e.forcedDuration ? a : e.forcedDuration,
							10
						)),
						(!d && e.pos === s.currPos && a) || (t = !1),
						"zoom" === t &&
							(e.pos === s.currPos &&
							a &&
							"image" === e.type &&
						...
						"zoom" === t
							? ((s.isAnimating = !0),
							  ...
							  p(e.$content),
							  void n.fancybox.animate(e.$content, l, a, function () {
							  ...
							  t
									? (n.fancybox.stop(o),
									  ...
									  void n.fancybox.animate(
											...
											a,
											function () {
												o.removeClass(i).css({ transform: "", opacity: "" }),
				...
				focus: function (e, i) {
					...
					s.isClosing ||
						((a = (a =
							...
							? ((r = a.index(t.activeElement)),
							  e && e.shiftKey
									? (r < 0 || 0 == r) &&
									  (e.preventDefault(), a.eq(a.length - 1).trigger("focus"))
									: (r < 0 || r == a.length - 1) &&
									  (e && e.preventDefault(), a.eq(0).trigger("focus")))
					...
					return !(
						...
						!1 === u.trigger("beforeClose", e)
							...
							: (u.removeEvents(),
							  ...
							  (a = n.isNumeric(t) ? t : i ? f.opts.animationDuration : 0),
							  f.$slide.removeClass(
					...
					s.current.$slide.trigger("onReset"),
						...
						s.current.opts.backFocus &&
							...
							o &&
								...
								(r = e.scrollY),
								o.trigger("focus"),
								n("html, body").scrollTop(r).scrollLeft(a))),
						(s.current = null),
				...
				trigger: function (e, t) {
					...
					if (
						(s ? a.unshift(s) : (s = r),
						a.unshift(r),
						n.isFunction(s.opts[e]) && (i = s.opts[e].apply(s, a)),
						!1 === i)
					)
						return i;
					"afterClose" !== e && r.$refs
						? r.$refs.container.trigger(e + ".fb", a)
						: o.trigger(e + ".fb", a);
				},
				updateControls: function () {
					...
					i.$slide.trigger("refresh"),
						o && o.length
							? ((e.$caption = s), s.children().eq(0).html(o))
							: (e.$caption = null),
						e.hasHiddenControls || e.isIdle || e.showControls(),
						r.find("[data-fancybox-count]").html(e.group.length),
						r.find("[data-fancybox-index]").html(a + 1),
						r
							.find("[data-fancybox-prev]")
							.prop("disabled", !i.opts.loop && a <= 0),
						r
							.find("[data-fancybox-next]")
							.prop("disabled", !i.opts.loop && a >= e.group.length - 1),
						"image" === i.type
							? r
					...
					return (
						(t = (e = e || {}).selector || !1)
							? n("body")
									...
									.on("click.fb-start", t, { options: e }, a)
		...
		(d.prototype.destroy = function () {
			...
			(d.prototype.ontouchstart = function (i) {
				...
				if (
					...
					(a.realPoints = a.startPoints = r(i)),
						a.startPoints.length &&
							...
							(a.canvasWidth = Math.round(p[0].clientWidth)),
							(a.canvasHeight = Math.round(p[0].clientHeight)),
							(a.contentLastPos = null),
							(a.contentStartPos = n.fancybox.getTranslate(a.$content) || {
								top: 0,
								left: 0,
							}),
							(a.sliderStartPos = n.fancybox.getTranslate(p)),
							...
							n.fancybox.isMobile &&
								t.addEventListener("scroll", a.onscroll, !0),
							(((a.opts || a.canPan) &&
								(l.is(a.$stage) || a.$stage.find(l).length)) ||
								(l.is(".fancybox-image") && i.preventDefault(),
								n.fancybox.isMobile &&
									l.parents(".fancybox-caption").length)) &&
								((a.isScrollable = c(l) || c(l.parent())),
								(n.fancybox.isMobile && a.isScrollable) || i.preventDefault(),
					...
					(o.isDragging = s.isSwiping),
						...
						n.each(o.slides, function (e, t) {
							...
							n.fancybox.stop(t.$slide),
								...
								t.pos === o.current.pos &&
									((s.sliderStartPos.top = i.top - a.top),
									(s.sliderStartPos.left = i.left - a.left)),
								n.fancybox.setTranslate(t.$slide, {
									top: i.top - a.top,
									left: i.left - a.left,
								});
			...
			(d.prototype.limitMovement = function () {
				...
				return (
					...
					c > 0 && a > e && (a = e - 1 + Math.pow(-e + p + c, 0.8) || 0),
			...
			(d.prototype.ontouchend = function (e) {
				...
				(i.speed = 100),
					...
					o ? i.endPanning() : l ? i.endZooming() : i.endSwiping(s, c);
			}),
				...
				(i.sliderLastPos = null),
					"y" == e && !t && Math.abs(i.distanceY) > 50
						? (n.fancybox.animate(
						  ...
						  (a = i.instance.close(!0, 250)))
						: o && i.distanceX > 0
						? (a = i.instance.previous(300))
						: o && i.distanceX < 0 && (a = i.instance.next(300)),
					!1 !== a || ("x" != e && "y" != e) || i.instance.centerSlide(200),
			...
			(d.prototype.endPanning = function () {
				var e,
					...
					a = this;
				a.contentLastPos &&
					(!1 === a.opts.momentum || a.dMs > 350
						? ((e = a.contentLastPos.left), (t = a.contentLastPos.top))
						: ((e = a.contentLastPos.left + 500 * a.velocityX),
					...
					((i = a.limitPosition(
						...
						a.contentStartPos.width,
						a.contentStartPos.height
					)).width = a.contentStartPos.width),
					(i.height = a.contentStartPos.height),
					n.fancybox.animate(a.$content, i, 366));
			}),
			(d.prototype.endZooming = function () {
				...
				r.contentLastPos &&
					...
					n.fancybox.setTranslate(r.$content, a),
			...
			(d.prototype.onTap = function (t) {
				var i,
					...
					d = c[0] ? c[0].x - n(e).scrollLeft() - a.stagePos.left : 0,
					u = c[0] ? c[0].y - n(e).scrollTop() - a.stagePos.top : 0,
					p = function (e) {
						var i = l.opts[e];
						...
						(a.tapX = d),
							...
							l.opts["dblclick" + i] !== l.opts["click" + i]
								? (a.tapped = setTimeout(function () {
										(a.tapped = null), o.isAnimating || p("click" + i);
								  }, 500))
								: p("click" + i);
					return this;
				}
	...
	(function (e, t) {
		...
		t.extend(n.prototype, {
			...
			t(e).on({
				...
				"afterKeydown.fb": function (n, i, a, r, s) {
					var o = i && i.SlideShow;
					!o ||
						!a.opts.slideShow ||
						(80 !== s && 32 !== s) ||
		...
		t.extend(i.prototype, {
			...
			create: function () {
				...
				i.$grid ||
					...
					).appendTo(a.$refs.container.find(r).addBack().filter(r))),
					...
					"x" === i.opts.axis &&
						i.$list.width(
							parseInt(i.$grid.css("padding-right"), 10) +
								a.group.length * i.$list.children().eq(0).outerWidth(!0)
						);
			},
			focus: function (e) {
				var t,
		...
		t.extend(!0, t.fancybox.defaults, {
			...
			t(e).on("click", "[data-fancybox-share]", function () {
				var e,
					...
					a = i.current || null;
				a &&
					("function" === t.type(a.opts.share.url) &&
						(e = a.opts.share.url.apply(a, [i, a])),
					(n = a.opts.share.tpl
						.replace(
							/\{\{media\}\}/g,
			...
			n(function () {
				!1 !== n.fancybox.defaults.hash &&
					(n(t).on({
						...
						"beforeShow.fb": function (n, i, a, s) {
							var o;
							a &&
								!1 !== a.opts.hash &&
								(o = r(i)) &&
								((i.currentHash =
									o + (i.group.length > 1 ? "-" + (a.index + 1) : "")),
	...
	(function (e) {
		...
		var t,
			...
			i = {
				start: function (t) {
					...
					t &&
						(r.call(this, t),
						(n = setTimeout(s.bind(this), 1e3)),
						this.data("ttStartTime", e.now()),
						this.data("intervalId", n));
				},
				stop: function () {
					var e = this.data();
					return (
						e.intervalId &&
							(clearTimeout(e.intervalId), this.data("intervalId", null)),
						e
					);
				},
				reset: function (e) {
					var t = i.stop.call(this),
						n = void 0 === e ? t.seconds : e;
		...
		function r(e, t) {
			var n,
				...
				f = this.find("ul"),
				h = !1;
			if (p.vals && 0 !== f.length) {
				for (
					e || (e = p.seconds),
						p.intervalId && ((h = !0), clearTimeout(p.intervalId)),
						i = 86400 * (n = Math.floor(e / 86400)),
						i += 3600 * (a = Math.floor((e - i) / 3600)),
						l =
							(n < 100 ? "0" + (n < 10 ? "0" : "") : "") +
							n +
							(a < 10 ? "0" : "") +
							a +
							((r = Math.floor((e - i) / 60)) < 10 ? "0" : "") +
							r +
							((o = e - (i += 60 * r)) < 10 ? "0" : "") +
							o,
						c = p.vals.length - 1,
					...
					(u = parseInt(l.substr(d, 1), 10)),
						(p.vals[c] = u),
						f.eq(c).children().html(u);
				(h || t) &&
					((p.ttStartTime = Date.now()),
					(p.intervalId = setTimeout(s.bind(this), 1e3)),
					this.data("intervalId", p.intervalId));
			}
		}
		function s(t) {
			var n,
				...
				d = this.find("ul"),
				u = this.data();
			if (!u.vals || 0 === d.length)
				return (
					u.intervalId &&
						(clearTimeout(u.intervalId), this.data("intervalId", null)),
					void (u.callback && u.callback())
				);
			void 0 === t && (t = u.iSec),
				this.data("tickCount", u.tickCount + 1),
				(n = u.vals[t]),
				(i = d.eq(t)),
				(a = i.children()),
				(r = u.countdown ? -1 : 1),
				a.eq(1).html(n),
				(n += r),
				"function" == typeof u.step &&
					u.tickCount % u.stepCount == 0 &&
					(this.data("tickCount", 0), u.step()),
				t === u.iSec &&
					((o = u.tickTimeout),
					(l = Date.now() - u.ttStartTime),
					(u.sec += r),
					(o += Math.abs(u.seconds - u.sec) * o - l),
					(u.intervalId = setTimeout(s.bind(this), o))),
				n < 0 || n > u.limits[t]
					? (n < 0
							? ((n = u.limits[t]),
							  t === u.iHour &&
					...
					? (i.addClass("transition"),
					  ...
					  setTimeout(function () {
							i.removeClass("transition"),
								a.eq(1).html(n),
								i.css({ top: "-" + u.height + "px" }),
								r > 0 ||
									t !== u.iSec ||
									(u.sec === u.countdownAlertLimit &&
										d.parent().addClass("timeTo-alert"),
									0 === u.sec &&
										(d.parent().removeClass("timeTo-alert"),
										u.intervalId &&
											(clearTimeout(u.intervalId), c.data("intervalId", null)),
				...
				for (t = 0; t < arguments.length; t += 1)
					(s = arguments[t]),
						0 === t && "string" == typeof s
							? (l = s)
							: "object" == typeof s
							? "function" == typeof s.getTime
								? (h.timeTo = s)
								: (h = e.extend(h, s))
							: "function" == typeof s
							? (h.callback = s)
							: ((o = parseInt(s, 10)), isNaN(o) || (h.seconds = o));
				if (h.timeTo)
					h.timeTo.getTime
						? (c = h.timeTo.getTime())
						: "number" == typeof h.timeTo && (c = h.timeTo),
						(h.seconds = c > m ? Math.floor((c - m) / 1e3) : 0);
				else if (h.time || !h.seconds)
					if (
						((c = h.time) || (c = new Date(m)),
						"object" == typeof c && c.getTime)
					)
						(h.seconds =
							86400 * c.getDate() +
							3600 * c.getHours() +
						...
						for (u = c.split(":"), p = 0, f = 1; u.length; )
							(p += u.pop() * f), (f *= 60);
						(h.seconds = p), (h.countdown = !1);
					}
				return (
					!1 !== h.countdown && h.seconds > 86400 && void 0 === h.displayDays
						? ((d = Math.floor(h.seconds / 86400)),
						  (h.displayDays = (d < 10 ? 1 : d < 100 && 2) || 3))
						: !0 === h.displayDays
						? (h.displayDays = 3)
						: h.displayDays &&
						  (h.displayDays =
								h.displayDays > 0 ? Math.floor(h.displayDays) : 3),
					this.each(function () {
						var t,
							s,
							o,
						...
						if (
							(P.intervalId &&
								(clearInterval(P.intervalId), (P.intervalId = null)),
							P.vals)
						)
							"reset" !== l && e.extend(P, h);
						else {
							if (
								((s = P.opt ? P.options : h),
								...
								((P = e.extend(t, s)).options = s),
								(P.height = Math.round((100 * P.fontSize) / 93) || P.height),
								(P.width =
									Math.round(0.8 * P.fontSize + 0.13 * P.height) || P.width),
								(P.displayHours = !(!P.displayDays && !P.displayHours)),
								(c = { fontFamily: P.fontFamily }),
								P.fontSize > 0 && (c.fontSize = P.fontSize + "px"),
								(d = P.languages[P.lang] || a[P.lang]),
								k
									.addClass("timeTo")
									.addClass("timeTo-" + P.theme)
									.css(c),
								(u =
									'<ul style="left:' +
									Math.round(P.height / 10) +
									"px; top:-" +
									P.height +
								...
								(m = "<div" + p + ">" + u),
								(v = "<span>:</span>"),
								(g = Math.round(2 * P.width + 3)),
								(b = (y =
									P.captionSize ||
									(P.fontSize && Math.round(0.43 * P.fontSize)))
									? "font-size:" + y + "px;"
									: ""),
								(w = y ? ' style="' + b + '"' : ""),
								(x = (
									P.displayCaptions
										? (P.displayHours
										  ...
										  d.sec +
										  "</figcaption></figure>"
										: (P.displayHours ? "$1" + v : "") + "$1" + v + "$1"
								).replace(/\$1/g, f + m)),
								P.displayDays > 0)
							) {
								for (
									S = Math.round(0.4 * P.fontSize || n.gap),
										T = f,
										o = P.displayDays - 1;
									o > 0;
									o -= 1
									...
									T +=
										1 === o ? m.replace('">', "margin-right:" + S + 'px">') : m;
								1 === P.displayDays &&
									(T = T.replace('">', "margin-right:" + S + 'px">')),
									(x =
										(P.displayCaptions
											? '<figure style="width:' +
											  (P.width * P.displayDays + S + 4) +
						...
						if ((E = k.find("div")).length < P.vals.length) {
							for (
								C = P.vals.length - E.length,
									$ = P.vals,
									M = P.limits,
									P.vals = [],
									P.limits = [],
								...
								(P.vals[o] = $[C + o]), (P.limits[o] = M[C + o]);
							(P.iSec = P.vals.length - 1), (P.iHour = P.vals.length - 5);
						}
						(P.sec = P.seconds),
							k.data(P),
							l && i[l]
								? i[l].call(k, P.seconds)
								: P.start
								? i.start.call(k, P.seconds)
								: r.call(k, P.seconds);
					})
				);
			}),
	...
	$(document).ready(function () {
		$(".select").length &&
			$(".select").select2({ minimumResultsForSearch: 1 / 0 }),
	...
	$(document).ready(function () {
		var e = $(".cookies"),
			t = e.find(".cookies__button--accept"),
			n = e.find(".cookies__button--close");
		e &&
			(Cookies.get("cookieAccepted") ||
				...
				t.click(function () {
					Cookies.set("cookieAccepted"), e.removeClass("visible");
				}),
				n.click(function () {
	...
	$(window).on("load", () => {
		let e = null,
			...
			n = !1;
		const i = document.querySelector(".services-section__carousel");
		if (i) {
			const s = new Swiper(i, {
				...
				o = document.querySelectorAll(".services-section__filter[data-target]"),
				l = document.querySelectorAll(".services-section__card");
			function a() {
				e = new Swiper(".services-section__filters", {
					speed: 300,
					slidesPerView: "auto",
					spaceBetween: 34,
				});
			...
			function r(e) {
				const t = (
					e || document.querySelector(".services-section__filter.active")
				).dataset.target;
				if (e)
					i.classList.add("opacity"),
						setTimeout(() => {
							for (slide of (i.classList.remove("opacity"), l)) {
								let e = slide.dataset.category.split(",");
								(e = e.map((e) => e.trim())), (slide.hidden = !e.includes(t));
							}
							s.update();
						}, 550);
				else {
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_steps-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_rating-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js-why-crypto-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_crypto-solution-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_crypto-line-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_team-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_advisors-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_documents-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_partners-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = null,
			t = document.documentElement.clientWidth,
			n = !1;
		const i = document.querySelector(".accordion"),
			a = "accordion__item--active",
			r = document.querySelectorAll(".faqs__filter[data-target]"),
			s = document.querySelectorAll(".accordion__item");
		if (
			i &&
			(i.addEventListener("click", (e) => {
				const t = e.target;
				t.closest(".accordion__item-header") &&
					(t.parentElement.classList.contains(a)
						? t.parentElement.classList.remove(a)
						: (s.forEach((e) => {
								e.classList.remove(a);
						  }),
						  t.parentElement.classList.add(a)));
			}),
			r)
		) {
			function o() {
				e = new Swiper(".__js_faq-filters", {
					speed: 300,
					slidesPerView: "auto",
				});
			}
		...
		function l(e) {
			const t = (e || document.querySelector(".faqs__filter.active")).dataset
				.target;
			if (e)
				i.classList.add("opacity"),
					i.addEventListener("transitionend", () => {
						for (item of s) {
							let e = item.dataset.category.split(",");
							(e = e.map((e) => e.trim())), (item.hidden = !e.includes(t));
						}
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_token-sale-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		const e = document.querySelector(".__js_timer");
		if (e) {
			const t = e.dataset.endDate;
			let n = new Date(t).getTime(),
				i = document.querySelector(".timer__column--days span"),
				a = document.querySelector(".timer__column--hours span"),
				r = document.querySelector(".timer__column--min span"),
				s = document.querySelector(".timer__column--sec span"),
				o = setInterval(function () {
					...
					i && (i.textContent = c.toString().padStart(2, "0")),
						a && (a.textContent = d.toString().padStart(2, "0")),
						r && (r.textContent = u.toString().padStart(2, "0")),
						s && (s.textContent = p.toString().padStart(2, "0")),
						l < 0 &&
							(clearInterval(o),
							(e.innerHTML =
								'<div class="timer__expired">' +
								e.dataset.expiredText +
								"</div>"));
				}, 1e3);
		}
	}),
	$(window).on("load", () => {
		let e = null,
			t = document.documentElement.clientWidth,
			n = !1;
		const i = document.querySelectorAll(".payments-map__filter[data-target]"),
			a = document.querySelectorAll(".pin"),
			r = document.querySelector(".payments-map__wrapper"),
			s = document.querySelector(".payments-map__buttons"),
			o = document.querySelector(".payments-map__map"),
			l = document.querySelector(".payments-map__container");
		if (i && a && r) {
			function c() {
				e = new Swiper(".__js_pins-filters", {
					speed: 300,
					slidesPerView: "auto",
				});
			}
			function d(e) {
				const t = (e || document.querySelector(".payments-map__filter.active"))
					.dataset.target;
				for (pin of a) {
					let e = pin.dataset.category.split(",");
					(e = e.map((e) => e.trim())),
						e.includes(t)
		...
		if (s && o) {
			const e = document.querySelector(".payments-map__btn--beginning"),
				n = document.querySelector(".payments-map__btn--end");
			function u() {
				t < o.offsetWidth
			...
			u(),
				e &&
					...
					(n.addEventListener("click", function () {
						(o.style.transform =
							"translateX(-" + (o.offsetWidth - l.offsetWidth) + "px)"),
	...
	$(window).on("load", () => {
		const e = document.documentElement,
			t = document.querySelector(".timeline__scene");
		let n = t ? t.offsetTop : null,
			i = e.clientWidth,
			a = !1,
			r = null;
		const s = document.querySelector(".__js_timeline-carousel"),
			o = [
				...
				{
					el: document.querySelector(".p31-8"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				{
					el: document.querySelector(".p31-7"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				{
					el: document.querySelector(".p31-6"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				{
					el: document.querySelector(".p31-5"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				{
					el: document.querySelector(".p31-4"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				{
					el: document.querySelector(".p31-3"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				{
					el: document.querySelector(".p31-2"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				{
					el: document.querySelector(".p31-1"),
					start: 1749,
					end: 1749,
					fill: "#00A99E",
				},
				...
				{
					el: document.querySelector(".timeline__item--2017-Q1"),
					start: 4273,
					end: 4252,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2017-Q2"),
					start: 3988,
					end: 3967,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2018-Q1"),
					start: 3704,
					end: 3678,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2018-Q2"),
					start: 3415,
					end: 3393,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2018-Q3"),
					start: 2517,
					end: 2491,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2018-Q4"),
					start: 2198,
					end: 2176,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2019-Q1"),
					start: 1861,
					end: 1835,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2019-Q2"),
					start: 1106,
					end: 1085,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2019-Q3"),
					start: 809,
					end: 787,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2019-Q4"),
					start: 515,
					end: 489,
					isQ: !0,
				},
				{
					el: document.querySelector(".timeline__item--2020-Q1"),
					start: 217,
					end: 192,
					isQ: !0,
				},
			],
			l = o.filter((e) => e.isQ).map((e) => e.el);
		if (t) {
			const p = n - e.clientHeight / 2;
			let f =
				t.offsetHeight -
				parseInt(
					window.getComputedStyle(t).getPropertyValue("padding-bottom"),
					10
				);
			const h = document.querySelector(".line"),
				m = h.getTotalLength();
			function c() {
				r = new Swiper(s, {
					speed: 300,
			...
			function d() {
				...
				if (e >= p) {
					let n = (m * ((100 * (e - p)) / f)) / 100;
					(h.style.strokeDashoffset = n < m ? m - n : 0),
						(t = m - n),
						o.forEach((e) => {
							const n = e.isQ ? null : e.el.getTotalLength(),
								i = e.el.hasAttribute("fill");
							e.el && t <= (e.start + e.end) / 2
								? (e.isQ && e.el.classList.add("timeline__item--active"),
								  i
										? e.el.setAttribute("fill", e.fill)
										: (e.el.style.strokeDashoffset = 0))
								: e.el &&
								  (e.isQ && e.el.classList.remove("timeline__item--active"),
								  i
										? e.el.setAttribute("fill", "none")
										: (e.el.style.strokeDashoffset = n));
						});
				} else h.style.strokeDashoffset = m;
				var t;
			}
			i <= 1079
				? (c(),
				  (a = !0),
				  l.forEach((e) => e.classList.add("timeline__item--active")))
				: (o.forEach((e) => {
						e.el &&
							(e.el.hasAttribute("fill")
								? e.el.setAttribute("fill", "none")
								: u(e.el, e.isQ));
				  }),
				  u(h),
				...
				window.addEventListener("resize", () => {
					(i = e.clientWidth),
						...
						i <= 1079 && !a
							? (c(), (a = !0))
							: i > 1079 && a && (r.destroy(), (a = !1)),
						l.forEach((e) => {
							i <= 1079
								? e.classList.add("timeline__item--active")
								: e.classList.remove("timeline__item--active");
						});
				});
		}
		function u(e, t) {
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_node-types-carousel");
		if (i) {
			function a() {
				n = new Swiper(i, {
					speed: 300,
	...
	$(window).on("load", () => {
		let e = document.documentElement.clientWidth,
			t = !1,
			n = null;
		const i = document.querySelector(".__js_how-to-get-pagi-carousel"),
			a = document.querySelector(".__js_how-to-get-carousel");
		if (i && a) {
			new Swiper(a, {
				slidesPerView: 1,
				speed: 300,
				...
				pagination: {
					...
					renderBullet: function (e, t) {
						return (
							'<button class="button button--dark-green button--rounded button--outline how-to-get__dot swiper-slide ' +
							t +
							'"><span>' +
							(this.passedParams.loop
								? this.slides[e + 1].dataset.bullet
								: this.slides[e].dataset.bullet) +
							"</span></button>"
						);
					},
				},
			...
			function r() {
				n = new Swiper(i, { speed: 300, slidesPerView: "auto" });
			}
			e <= 767 && (r(), (t = !0)),
				window.addEventListener("resize", () => {
					(e = document.documentElement.clientWidth),
	...
	$(document).ready(function () {
		...
		function n() {
			!0 !== t.matches
				? !1 !== t.matches ||
				  (e = new Swiper(".__js_footer-carousel", {
						slidesPerView: 1,
						speed: 300,
						loop: !0,
						pagination: {
	...
	$(document).ready(function () {
		var e = $(".footer__menu").outerWidth(),
			t = $(".footer__menu-item"),
			n = $(".footer__bottom-links"),
			i = window.matchMedia("(max-width: 1079px)");
		function a(t) {
			$(this).find("a:not(.top-link)").removeAttr("class"),
				t.each(function () {
					var t = $(this).find("a:not(.top-link)"),
						n = 0;
					t.each(function () {
						0 === n
							? (n = $(this).outerWidth(!0))
							: n + $(this).outerWidth(!0) < e
							? ((n += $(this).outerWidth(!0)), $(this).addClass("dot"))
							: (n = $(this).outerWidth(!0));
					});
				});
		}
		i.addListener(function () {
			!0 === i.matches
				? (a(t), a(n))
				: !1 === i.matches && t.find("a:not(.top-link)").removeAttr("class");
		});
	}),
	$(document).ready(function () {
		var e,
			t = window.matchMedia("(min-width: 1080px)"),
			n = ["Маркетинг", "Продажи", "Рекрутинг", "Менеджмент"];
		function i() {
			!0 !== t.matches
				? !1 !== t.matches ||
				  (e = new Swiper(".__js_applying-pagi-carousel", {
						slidesPerView: 2.24,
						speed: 300,
						spaceBetween: 34,
						breakpoints: {
							561: { slidesPerView: 3.24 },
							768: { slidesPerView: 4.24 },
						},
				  }))
				: void 0 !== e && e.destroy(!0, !0);
		}
		(applyingCarousel = new Swiper(".__js_applying-carousel", {
			...
			pagination: {
				...
				renderBullet: function (e, t) {
					return (
						'<button class="button button--dark-green button--rounded button--outline applying__filter-btn swiper-slide ' +
						t +
						'"><span>' +
						n[e] +
						"</span></button>"
	...
	$(document).ready(function () {
		...
		function n() {
			!0 !== t.matches
				? !1 !== t.matches ||
				  (e = new Swiper(".__js_records-carousel", {
						slidesPerView: "auto",
						speed: 300,
						loop: !0,
						spaceBetween: 15,
						navigation: { nextEl: ".slider-next-long" },
				  }))
				: void 0 !== e && e.destroy(!0, !0);
		}
		t.addListener(n), n();
	...
	$(document).ready(function () {
		...
		function n() {
			!0 !== t.matches
				? !1 !== t.matches ||
				  (e = new Swiper(".__js_blog-carousel", {
						slidesPerView: 1.6,
						speed: 300,
						spaceBetween: 19,
						loop: !0,
